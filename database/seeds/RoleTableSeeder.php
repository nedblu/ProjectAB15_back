...
class RoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('roles')->insert(['name' => 'Editor','slug' => str_slug('EDITOR'),'description' => 'Use this for people that helps to fix typos, Can\'t create new things.','level' => 4,'created_at' => \Carbon\Carbon::now()->toDateTimeString(),'updated_at' => \Carbon\Carbon::now()->toDateTimeString()]);
    }
}