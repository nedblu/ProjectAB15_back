...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		DB::table('permission_role')->insert(['permission_id' => '12','role_id' => '1']);
		DB::table('permission_role')->insert(['permission_id' => '13','role_id' => '1']);
		DB::table('permission_role')->insert(['permission_id' => '14','role_id' => '1']);
		DB::table('permission_role')->insert(['permission_id' => '15','role_id' => '1']);
		...
		DB::table('permission_role')->insert(['permission_id' => '7','role_id' => '2']);
		...
		DB::table('permission_role')->insert(['permission_id' => '13','role_id' => '2']);
		...
		DB::table('permission_role')->insert(['permission_id' => '2','role_id' => '4']);
		DB::table('permission_role')->insert(['permission_id' => '3','role_id' => '4']);
		DB::table('permission_role')->insert(['permission_id' => '7','role_id' => '4']);
		DB::table('permission_role')->insert(['permission_id' => '8','role_id' => '4']);
