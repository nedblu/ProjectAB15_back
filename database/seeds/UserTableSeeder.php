...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([ 'first_name' => 'editor',        'last_name' => 'editor',        'username' => 'editor',         'email' => 'editor@gmail.com',           'password' => Hash::make('devtest'), 'active' => '1', 'created_at' => \Carbon\Carbon::now()->toDateTimeString(), 'updated_at' => \Carbon\Carbon::now()->toDateTimeString()]);
        ...
        DB::table('users')->insert([ 'first_name' => 'moderator',     'last_name' => 'moderator',     'username' => 'moderator',      'email' => 'moderator@gmail.com',        'password' => Hash::make('devtest'), 'active' => '1', 'created_at' => \Carbon\Carbon::now()->toDateTimeString(), 'updated_at' => \Carbon\Carbon::now()->toDateTimeString()]);
    }
}
