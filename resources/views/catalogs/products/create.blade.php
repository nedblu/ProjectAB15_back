...
<form method="post" action="{{ route('Products::store' ) }}" accept-charset="UTF-8" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="checkbox">
                <label for="colors"><input type="checkbox" name="checkColors"> <strong>Colores del Producto (Opcional)</strong></label>
            </div>
            <input type="text" class="form-control" name="colors" disabled placeholder="Colores del Producto" value="{{ old('colors') }}" aria-describedby="colorsHelp" >
            <span id="colorsHelp" class="help-block">Habilita este campo en caso de que el producto tenga colores.</span>
        </div>

        <div class="form-group">
            <div class="checkbox">
                <label for="inks"><input type="checkbox" name="checkInks"> <strong>Tintas ligadas (Opcional)</strong></label>
            </div>
            <input type="text" class="form-control" name="inks" disabled placeholder="Tintas ligadas" value="{{ old('inks') }}" aria-describedby="inksHelp" >
            <span id="inksHelp" class="help-block">Habilita este campo en caso de que haya tintas ligadas al producto.</span>
        </div>

        <div class="form-group">
            <div class="checkbox">
                <label for="equipments"><input type="checkbox" name="checkEquipment"> <strong>Equipos ligados (Opcional)</strong></label>
            </div>
            <input type="text" class="form-control" name="equipments" disabled placeholder="Equipos ligados" value="{{ old('equipments') }}" aria-describedby="equipmentsHelp" >
