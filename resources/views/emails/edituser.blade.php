                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Hola {{ $account->first_name }}, ahora eres {{ $role->name }} en AlphaBeta</td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                AlphaBeta te ha reasignado {{ $role->name }}, por lo que ahora podrás realizar las siguientes operaciones:<br><i>{{ $role->description }}</i>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
